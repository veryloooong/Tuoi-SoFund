        ...
        <div className="p-0 my-0 w-full min-w-full">
            ...
            <div className="min-h-[20rem] bg-palette3 grid grid-cols-1 py-4 xl:grid-cols-2 gap-2">
                <div className="col-span-1 text-center xl:text-left px-4 md:px-10 flex flex-row justify-center items-center gap-5">
                    <svg className="hidden xl:block" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M16 8V5L19 2L20 4L22 5L19 8H16ZM16 8L12 11.9999M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2M17 12C17 14.7614 14.7614 17 12 17C9.23858 17 7 14.7614 7 12C7 9.23858 9.23858 7 12 7" stroke="#c7f9cc" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
