    ...
    <div className="mb-10 pb-10 w-full mx-auto rounded-xl">
      <div className="absolute w-full py-5 mb-5 px-10 xl:px-20 bg-palette2 flex flex-row items-center content-center xl:justify-between">
        ...
        <div className="w-1/2 xl:w-1/3 flex flex-row gap-2 xl:gap-5">
          <button className="inline-block w-full xl:w-1/2 h-10 px-4 text-lg rounded-full bg-palette3 shadow-lg text-white" onClick={todoClick}>Đóng góp</button>
          <button className="inline-block w-full xl:w-1/2 h-10 px-4 text-lg rounded-full bg-palette1 shadow-lg text-white" onClick={todoClick}>Chia sẻ</button>
        </div>
      </div>
        ...
        <div>
          <div className={borderClass}>
            <div className="flex flex-row items-center gap-5">
              <svg className="h-16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#22577a"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <circle cx="12" cy="6" r="4" fill="#22577a"></circle> <path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" fill="#22577a"></path> </g></svg>
              <div>
            ...
            <div className="flex flex-row items-center gap-5">
              <svg className="h-16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#22577a"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M14.5 9C14.5 9 13.7609 8 11.9999 8C8.49998 8 8.49998 12 11.9999 12C15.4999 12 15.5 16 12 16C10.5 16 9.5 15 9.5 15" stroke="#22577a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M12 7V17" stroke="#22577a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="#22577a" stroke-width="2"></path> </g></svg>
              <div>
                <h4 className="font-bold text-palette1 text-3xl">1 tỉ (getdb)</h4>
                <p>Số tiền quyên góp</p>
              </div>
            </div>
            <div id="progress-bar" className="h-4 w-full bg-palette1 rounded-full">
              <div id="current-progress" className="h-full w-1/2 bg-palette3 rounded-full"></div>
            </div>
            <p><span className="font-bold">Mục tiêu:</span> 2 tỉ (extract from db) VND</p>
            <p><span className="font-bold">Thời hạn còn lại:</span> (extract from db) ngày</p>
          </div>
          <br />
          <div className={borderClass}>
